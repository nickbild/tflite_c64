...
inline int32_t MultiplyByQuantizedMultiplier(int32_t x,
  ...
  printf("NAB MultiplyByQuantizedMultiplier QUANT MULTIPLIER %d\n", quantized_multiplier);
  printf("NAB MultiplyByQuantizedMultiplier ROUND %d\n", round);
  printf("NAB MultiplyByQuantizedMultiplier TOTAL SHIFT %d\n", total_shift);
...
inline int32_t MultiplyByQuantizedMultiplier(int32_t x,
  ...
  //printf("7777777777777777777777777777777777777777777777777777777\n");
  using gemmlowp::RoundingDivideByPOT;
  using gemmlowp::SaturatingRoundingDoublingHighMul;
