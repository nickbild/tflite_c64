...
TF_LITE_MICRO_TEST(LoadModelAndPerformInference) {
  ...
  TF_LITE_MICRO_EXPECT_NEAR(y_true, y_pred, epsilon);
    ...
    printf("NAB OUTPUT Y TRUE %f\n", (double)y_true);
  printf("NAB OUTPUT Y PREDICTED %f\n", (double)y_pred);
  ...
  printf("NAB OUTPUT IN SCALE %f\n", (double)input_scale);
  printf("NAB OUTPUT IN ZERO POINT %d\n", input_zero_point);
  
  printf("NAB OUTPUT Y TRUE %f\n", (double)y_true);
  printf("NAB OUTPUT Y PREDICTED %f\n", (double)y_pred);
  printf("NAB OUTPUT DATA %i\n", output->data.int8[0]);
  printf("NAB OUTPUT ZERO POINT %i\n", output_zero_point);
  printf("NAB OUTPUT SCALE %f\n", (double)output_scale);
